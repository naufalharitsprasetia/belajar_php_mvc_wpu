            ...
            <ul class="list-group">
                ...
                <li class="list-group-item"><?= $mhs["nama"]; ?>
                    <a href="<?= BASEURL; ?>/mahasiswa/hapus/<?= $mhs["id"]; ?>"
                        class="badge text-bg-danger float-end ms-2 text-decoration-none"
                        onclick="return confirm('yakin??');">Hapus</a>
                    <a href="<?= BASEURL; ?>/mahasiswa/ubah/<?= $mhs["id"]; ?>"
                        class="badge text-bg-success float-end tampilModalUbah ms-2 text-decoration-none"
                        data-bs-toggle="modal" data-bs-target="#formModal" data-id="<?= $mhs['id']; ?>">Ubah</a>
                    <a href="<?= BASEURL; ?>/mahasiswa/detail/<?= $mhs["id"]; ?>"
                        class="badge text-bg-primary float-end ms-2 text-decoration-none">Detail</a>
                </li>
                <?php endforeach ; ?>
            </ul>
        </div>
